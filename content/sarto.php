...
<main class="sarto-main">

    <a class="bouton photo" href="Javascript:history.go(-1)"> < Retour</a>

    <h1>Le Sartorialisme</h1>

    <div class="sarto-main1">
...
<footer>
        ...
        <div class="container-footer">
                ...
                <div class="container-footer2">
                        ...
                        <div class="footerbox container-footer2-img2">
                                <a href="">
                                        <img target="_blank" src="../img/logo/insta-logo.png" alt="">
                                </a>        
                        </div>
                        <div class="footerbox container-footer2-img3">
                                <a target="_blank" href="https://twitter.com/elonmusk">
                                        <img  src="../img/logo/x-logo.png" alt="">
                                </a>                        
                        </div>
                        <div class="footerbox container-footer2-img4">
                                <a target="_blank" href="https://www.linkedin.com/in/martin-charpentier-7a406822b/">
                                        <img class="logo-linkedin"  src="../img/logo/linkedin-logo.png" alt="">
                                </a>
                        </div>
                </div>
        </div>
